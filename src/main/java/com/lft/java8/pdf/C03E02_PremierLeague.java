...
public class C03E02_PremierLeague {
    ...
    public static final String DATA = "E:\\study\\java8\\src\\main\\java\\com\\lft\\java8\\pdf\\data\\premier_league.csv";
    public static final String DEST = "d:\\pdf\\premier_league.pdf";
