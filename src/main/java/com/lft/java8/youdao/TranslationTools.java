...
public class TranslationTools {
    ...
    private static Logger logger = LoggerFactory.getLogger(TranslationTools.class);

    private static final String YOUDAO_URL = "https://openapi.youdao.com/api";

    private static final String APP_KEY = "038ff96c5b4aec4c";

    private static final String APP_SECRET = "ZYO9pRGkIlusnMclADqNslw0WHQeMluW";

    public static void main(String[] args) throws IOException {
        String translate = translate("你好");
